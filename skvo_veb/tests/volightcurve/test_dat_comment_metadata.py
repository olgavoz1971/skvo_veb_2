...
from skvo_veb.utils.lc_config import PHOTCAL_KEY_FILTER_IDENTIFIER, PHOTCAL_KEY_FILTER_NAME
...
"""
    ...
    lcd = volc_to_curvedash(volc, "e.dat", preserve_photcal=False)
...
"""
    volc = ingest_volightcurve_file(io.BytesIO(dat), "user.dat")
    lcd = volc_to_curvedash(volc, "user.dat", preserve_photcal=False)
